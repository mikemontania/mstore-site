...
export class ShowProductoComponent implements OnInit {
        ...
        this._guestService.obtener_productos_slug_publico(this.slug).subscribe(
          response=>{
            ...
            if(response.data != undefined){
              ...
              this._guestService.get_categorias().subscribe(
                response=>{
                  for(var item of response){
                    if(item.id == this.producto.categoria){
              ...
              this._guestService.obtener_reviews_producto_publico(this.producto.id).subscribe(
                response=>{
  ...
  init_variedades(){
    this._guestService.obtener_variedades_productos_cliente(this.producto.id).subscribe(
      response=>{
